...
import com.gw.example.coolweather.gson.Forecast;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titleCity = (TextView) findViewById(R.id.tv_city);
    ...
    private void requestWeather(String weatherId) {
        ...
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=d6052417aeb34f56bdc8888b8c98841d";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        String weatherInfo = weather.now.moew.info;
        ...
        for (Forecast f : weather.forecastList) {
            ...
            maxText.setText(f.temperature.min);
